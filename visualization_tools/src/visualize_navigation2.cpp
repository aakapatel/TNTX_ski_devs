...
namespace visualization_tools
{
  ...
  VisualizeNavigation2::VisualizeNavigation2(ros::NodeHandle &nodeHandle)
      : nodeHandle_(nodeHandle)
  {

    odom_subscriber_ = nodeHandle_.subscribe("/pelican/ground_truth/odometry", 1,
                                             &VisualizeNavigation2::OdometryCallback, this);
    gt_traj_pub_ = nodeHandle_.advertise<nav_msgs::Path>("pelican/gt_path", 1);

    odom_noise_subscriber_ = nodeHandle_.subscribe("/pixy/noisevalue", 1,
                                                   &VisualizeNavigation2::NoiseOdometryCallback, this);
    noise_traj_pub_ = nodeHandle_.advertise<nav_msgs::Path>("/noise_path", 1);

    waypoints_subscriber_ = nodeHandle_.subscribe("/pelican/reference", 1,
                                                  &VisualizeNavigation2::WaypointsCallback, this);

    laserscan_subscriber_ = nodeHandle_.subscribe("/something/velodyne_points", 1,
                                                  &VisualizeNavigation2::LaserCallback, this);
  ...
  VisualizeNavigation2::~VisualizeNavigation2()
  {
  }

  void VisualizeNavigation2::OdometryCallback(const nav_msgs::Odometry &msg)
  {
  ...
  void VisualizeNavigation2::NoiseOdometryCallback(const nav_msgs::Odometry &msg)
  {
    /*
  counter_cleaner++;
  ...
  void VisualizeNavigation2::WaypointsCallback(const nav_msgs::Odometry &msg)
  {
  ...
  void VisualizeNavigation2::LaserCallback(const sensor_msgs::LaserScan &scan_msg)
  {
