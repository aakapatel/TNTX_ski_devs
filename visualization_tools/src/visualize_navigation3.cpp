...
namespace visualization_tools
{
  ...
  VisualizeNavigation3::VisualizeNavigation3(ros::NodeHandle &nodeHandle)
      : nodeHandle_(nodeHandle)
  {

    odom_subscriber_ = nodeHandle_.subscribe("/pelican_2/ground_truth/odometry", 1,
                                             &VisualizeNavigation3::OdometryCallback, this);
    gt_traj_pub_ = nodeHandle_.advertise<nav_msgs::Path>("pelican_2/gt_path", 1);

    odom_noise_subscriber_ = nodeHandle_.subscribe("/pixy/noisevalue", 1,
                                                   &VisualizeNavigation3::NoiseOdometryCallback, this);
    noise_traj_pub_ = nodeHandle_.advertise<nav_msgs::Path>("/noise_path", 1);

    waypoints_subscriber_ = nodeHandle_.subscribe("/pelican_2/reference", 1,
                                                  &VisualizeNavigation3::WaypointsCallback, this);

    laserscan_subscriber_ = nodeHandle_.subscribe("/something/velodyne_points", 1,
                                                  &VisualizeNavigation3::LaserCallback, this);
  ...
  VisualizeNavigation3::~VisualizeNavigation3()
  {
  }

  void VisualizeNavigation3::OdometryCallback(const nav_msgs::Odometry &msg)
  {
  ...
  void VisualizeNavigation3::NoiseOdometryCallback(const nav_msgs::Odometry &msg)
  {
    /*
  counter_cleaner++;
  ...
  void VisualizeNavigation3::WaypointsCallback(const nav_msgs::Odometry &msg)
  {
  ...
  void VisualizeNavigation3::LaserCallback(const sensor_msgs::LaserScan &scan_msg)
  {
