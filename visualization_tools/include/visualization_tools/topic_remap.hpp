...
class VisualizeNavigation
{
public:
  VisualizeNavigation(ros::NodeHandle &nodeHandle);

  virtual ~VisualizeNavigation();
...
private:
  ...
  ros::Subscriber pose_reference_subscriber_;
  ...
  ros::Publisher potential_point_pub;
  ros::Publisher pose_reference_publisher_;
};
